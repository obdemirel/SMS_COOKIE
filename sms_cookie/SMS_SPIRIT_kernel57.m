function [data_kspace,data_ak_set,kernel_r,kernel_s] = ROCK_SPIRIT_kernel57(kspace,acs,kernels,slice_R,gui_on,par_on)
...
for kernel_in = 1:slice_R
    conc_acs_fregion = squeeze(acs(:,:,:,kernel_in));
